...
// Automation tests for UCodeForgeBlueprint::Validate() and ApplyAutoFix() â€” Task 4.
...
// ===========================================================================
// Rule 1 â€” Duplicate property/function names within the same class
// ===========================================================================
...
// ===========================================================================
// Rule 2 â€” Invalid specifier combo (bBlueprintReadWrite + bBlueprintReadOnly both true)
// ===========================================================================
...
// ===========================================================================
// Rule 4 â€” Missing parent class (ClassName is empty)
// ===========================================================================
...
bool FValidate_Rule04_MissingClassName::RunTest(const FString& Parameters)
{
    UCodeForgeBlueprint* BP = NewObject<UCodeForgeBlueprint>();
    BP->BlueprintKind = ECodeForgeBlueprintKind::Class;
    BP->ClassName     = TEXT(""); // empty â€” invalid
...
// ===========================================================================
// Rule 5 â€” Reserved name collision ("Class", "Super", "StaticClass")
// ===========================================================================
...
// ===========================================================================
// Rule 8 â€” RepNotify without Replicated
// ===========================================================================
...
// ===========================================================================
// Rule 9 â€” Bool not prefixed with 'b'
// ===========================================================================
...
{
    // "balive" starts with 'b' but second char is lowercase â€” still invalid
    UCodeForgeBlueprint* BP = NewObject<UCodeForgeBlueprint>();
    BP->BlueprintKind = ECodeForgeBlueprintKind::Class;
    BP->ClassName     = TEXT("AMyActor");
    BP->ClassType     = ECodeForgeClassType::Actor;
    ...
    FCodeForgePropertyDef Prop;
    Prop.Name = TEXT("balive"); // 'b' followed by lowercase â€” invalid
    Prop.Type = TEXT("bool");
    BP->Properties.Add(Prop);
...
// ===========================================================================
// Rule 11 â€” Replicated property on non-Actor class
// ===========================================================================
...
// ===========================================================================
// Rule 12 â€” Replication specifiers on Struct property
// ===========================================================================
...
// ===========================================================================
// Positive test â€” valid blueprint produces no errors
// ===========================================================================
