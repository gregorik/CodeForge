...
// Automation tests for FCodeForgeTemplateEngine — written TDD-style (tests first).
...
// ============================================================
//  Test 10: Error — Unknown Variable
// ============================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
