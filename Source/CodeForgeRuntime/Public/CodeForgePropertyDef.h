...
struct CODEFORGERUNTIME_API FCodeForgePropertyDef
{
    ...
    // Edit specifiers (mutually exclusive â€” first true wins)
    ...
    // Blueprint specifiers (mutually exclusive â€” first true wins)
    ...
    /** Optional OnRep_ function body. Empty â†’ "// TODO". Non-empty â†’ verbatim. */
