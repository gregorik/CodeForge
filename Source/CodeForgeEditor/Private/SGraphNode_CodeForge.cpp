...
namespace CodeForgeNodeStyle
{
	...
	/** Body background — reads brightness from settings with optional tinting. */
...
// ---------------------------------------------------------------------------
// UpdateGraphNode — branded layout
// ---------------------------------------------------------------------------
...
void SGraphNode_CodeForge::UpdateGraphNode()
{
	...
	// Badge background — saturated version of the title color
	...
	[
		...
		[
			...
			// ── Top accent stripe (2px brand line) ──
			+ SVerticalBox::Slot()
			.AutoHeight()
			[
				SNew(SBox)
