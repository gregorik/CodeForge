...
// End-to-end automation tests for the CodeForge pipeline â€” Task 11.
//
...
// ===========================================================================
// Test 1 â€” Full replicated Actor (most comprehensive)
// ===========================================================================
...
bool FCodeForgeEndToEndTest_ReplicatedActorFull::RunTest(const FString& Parameters)
{
	...
	// Property 1 â€” Health (replicated with notify)
	{
	...
	// Property 2 â€” MaxHealth (non-replicated, defaults-only)
	{
		FCodeForgePropertyDef Prop;
	...
	// Property 3 â€” DisplayName (with Meta)
	{
		FCodeForgePropertyDef Prop;
	...
	// Function 2 â€” GetHealthPercent (pure, const)
	{
		FCodeForgeFunctionDef Func;
...
bool FCodeForgeEndToEndTest_EnumGeneration::RunTest(const FString& Parameters)
{
	...
	// Entry 2 â€” Green (no explicit value, no display name)
	{
		FCodeForgeEnumEntryDef Entry;
...
// ===========================================================================
// Test 4 â€” Validation catches errors and generation fails
// ===========================================================================
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
